      ...
      <PageHeader
        ...
        actions={
          <div className="flex gap-1.5 md:gap-2 flex-wrap">
            ...
            <Button className="btn-gradient text-white shadow-lg hover:shadow-xl text-xs md:text-sm" size="sm">
            ...
            <ScrollArea className="flex-1 p-3 md:p-4 lg:p-6 bg-gradient-to-b from-background to-muted/10">
              {!selectedConversation ? (
                <div className="flex flex-col items-center justify-center h-full text-center">
                  <MessageSquare className="w-12 h-12 md:w-16 md:h-16 text-muted-foreground mb-4" />
