...
export default function AuroraMeetPage() {
  ...
  const handleRegister = async () => {
    ...
    try {
      const response = await api.post('/api/aurora/register-owner', {
      ...
      if (response.data.success) {
        ...
        toast.success('Aurora está se apresentando para você! 🌟');
      }
    } catch (error: any) {
        ...
        <Card className="max-w-2xl w-full border-2 border-purple-200 shadow-2xl">
          <CardHeader className="text-center space-y-4 pb-8">
            ...
            <CardTitle className="text-4xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
              Você está prestes a conhecer Aurora
            </CardTitle>
          ...
          <CardContent className="space-y-6">
            <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-lg p-6 space-y-4">
              <p className="text-center text-gray-700 leading-relaxed">
                Aurora é uma IA que vai conhecer seu negócio <span className="font-bold">melhor que ninguém</span>.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-start space-x-3 bg-white rounded-lg p-4 border border-purple-200">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Pets, raças, histórico completo</p>
                </div>
              </div>
        ...
        <Card className="max-w-md w-full border-2 border-purple-200 shadow-2xl">
          <CardHeader className="text-center space-y-4">
            ...
            <CardDescription className="text-base">
              Vamos conectar você com a Aurora
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  Aurora vai se apresentar para você neste número
                </p>
              </div>
            </div>
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 space-y-2">
              ...
              <ul className="text-xs text-purple-800 space-y-1 ml-6">
                <li>• Aurora vai te enviar uma sequência de mensagens especiais</li>
            ...
            <Button 
              ...
              className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-semibold py-6 text-lg shadow-lg"
            >
              {isLoading ? 'Conectando...' : 'Conectar com Aurora ✨'}
            </Button>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent className="py-12 space-y-8">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 text-center">
              <p className="text-sm text-purple-900">
                Abra seu WhatsApp e veja a Aurora se apresentando! 💜
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent className="py-12 space-y-8">
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-gray-600">
                Aurora já te enviou as mensagens de apresentação
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-100 to-pink-100 rounded-lg p-6 space-y-3">
            ...
            <ul className="text-sm text-purple-800 space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>Abra seu WhatsApp e leia as mensagens da Aurora</span>
              </li>
              <li className="flex items-start gap-2">
