  ...
  const fetchAnalytics = async () => {
    try {
      ...
      const [kpisRes, funnelRes, revenueRes] = await Promise.all([
        axios.get(`${API_URL}/api/internal/analytics/kpis?${params}`, {
          headers: { Authorization: `Bearer ${token}` }
        }),
        axios.get(`${API_URL}/api/internal/analytics/conversion-funnel?${params}`, {
          headers: { Authorization: `Bearer ${token}` }
        }),
        axios.get(`${API_URL}/api/internal/analytics/revenue?${params}&group_by=day`, {
          headers: { Authorization: `Bearer ${token}` }
        })
      ]);
