...
export default function CreateClientModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Erro ao criar cliente: ' + (error.response?.data?.error || 'Tente novamente'));
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <Dialog open={isOpen} onOpenChange={handleCancel}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Preencha os dados para criar uma nova organização e usuário owner
          </DialogDescription>
        </DialogHeader>
