...
export function ClientAnalytics({ clients, dateRange }: ClientAnalyticsProps) {
  ...
  const metrics = useMemo(() => {
    ...
    const weeklyEngagement = [
      { day: "Seg", messages: 45, bookings: 12 },
      { day: "Ter", messages: 52, bookings: 15 },
      { day: "Qua", messages: 38, bookings: 10 },
      { day: "Qui", messages: 65, bookings: 18 },
      { day: "Sex", messages: 58, bookings: 20 },
      { day: "Sáb", messages: 72, bookings: 25 },
      { day: "Dom", messages: 30, bookings: 8 },
    ];
