...
export class AuroraDailySummaryJob {
  ...
  constructor() {
    // Queue configuration
    this.queue = new Queue<DailySummaryJobData>('aurora-daily-summary', {
    ...
    logger.info('Aurora Daily Summary Job initialized');
  }
  ...
  private async scheduleRecurringSummaries(): Promise<void> {
    ...
    await this.queue.add(
      ...
      {} as any,
      {
        ...
        jobId: 'aurora-daily-summary-trigger'
      }
    );
  ...
  public async close(): Promise<void> {
    ...
    logger.info('Aurora Daily Summary Job closed');
  }
}
