...
/**
 * Script para criar 5 usuários internos no sistema AuZap
 *
 * Usuários criados:
...
const users: InternalUser[] = [
  {
    ...
    email: 'fellipe@auzap.com',
    password: 'Admin@2025',
    role: 'super_admin'
  },
  {
    name: 'João Silva',
    email: 'joao.silva@auzap.com',
    password: 'Tech@2025',
    role: 'tech'
  },
  {
    name: 'Maria Santos',
    email: 'maria.santos@auzap.com',
    password: 'CS@2025',
    role: 'cs'
  },
  {
    name: 'Pedro Costa',
    email: 'pedro.costa@auzap.com',
    password: 'Sales@2025',
    role: 'sales'
  },
  {
    name: 'Ana Oliveira',
    email: 'ana.oliveira@auzap.com',
...
async function createInternalUsers() {
  console.log('🔐 Criando usuários internos do AuZap...\n');
