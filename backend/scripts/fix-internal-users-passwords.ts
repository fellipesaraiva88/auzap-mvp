...
const userPasswords: Record<string, string> = {
  'fellipe@auzap.com': 'Admin@2025',
  'joao.silva@auzap.com': 'Tech@2025',
  'maria.santos@auzap.com': 'CS@2025',
  'pedro.costa@auzap.com': 'Sales@2025',
  'ana.oliveira@auzap.com': 'Marketing@2025'
};
...
async function fixInternalUsers() {
  ...
  const users = [
    { name: 'Fellipe Saraiva', email: 'fellipe@auzap.com', password: 'Admin@2025' },
    { name: 'João Silva', email: 'joao.silva@auzap.com', password: 'Tech@2025' },
    { name: 'Maria Santos', email: 'maria.santos@auzap.com', password: 'CS@2025' },
    { name: 'Pedro Costa', email: 'pedro.costa@auzap.com', password: 'Sales@2025' },
    { name: 'Ana Oliveira', email: 'ana.oliveira@auzap.com', password: 'Marketing@2025' }
  ];
