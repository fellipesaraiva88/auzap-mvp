...
test.describe('Training Plans - Vertical Tests', () => {
  test.beforeEach(async ({ page }) => {
    // Login
    await page.goto('https://auzap-frontend-d84c.onrender.com/login');
  ...
  test('Página de Training Plans deve estar acessível', async ({ page }) => {
    ...
    for (const route of trainingRoutes) {
      await page.goto(`https://auzap-frontend-d84c.onrender.com${route}`);
  ...
  test('Lista de planos de adestramento deve ser exibida', async ({ page }) => {
    await page.goto('https://auzap-frontend-d84c.onrender.com/training');
    await page.waitForLoadState('networkidle');
  ...
  test('Backend Training API deve estar respondendo', async ({ page }) => {
    ...
    const response = await page.request.get('https://auzap-backend-8xyx.onrender.com/api/v1/training').catch(() => null);

    // Endpoint may require auth, so we just check backend is alive
    const healthResponse = await page.request.get('https://auzap-backend-8xyx.onrender.com/health');
...
test.describe('Daycare/Hotel - Vertical Tests', () => {
  ...
  test('Lista de reservas deve ser exibida', async ({ page }) => {
    await page.goto('https://auzap-frontend-d84c.onrender.com/daycare');
    await page.waitForLoadState('networkidle');
  ...
  test('Backend Daycare API deve estar respondendo', async ({ page }) => {
    ...
    const response = await page.request.get('https://auzap-backend-8xyx.onrender.com/api/v1/daycare').catch(() => null);
...
test.describe('BIPE Protocol - Vertical Tests', () => {
  ...
  test('Lista de protocolos BIPE deve ser exibida', async ({ page }) => {
    await page.goto('https://auzap-frontend-d84c.onrender.com/bipe');
    await page.waitForLoadState('networkidle');
  ...
  test('Histórico de protocolos por pet deve estar disponível', async ({ page }) => {
    ...
    await page.goto('https://auzap-frontend-d84c.onrender.com/pets');
    await page.waitForLoadState('networkidle');
  ...
  test('Backend BIPE API deve estar respondendo', async ({ page }) => {
    ...
    const response = await page.request.get('https://auzap-backend-8xyx.onrender.com/api/v1/bipe').catch(() => null);
...
test.describe('Knowledge Base - Vertical Tests', () => {
  ...
  test('Lista de artigos KB deve ser exibida', async ({ page }) => {
    await page.goto('https://auzap-frontend-d84c.onrender.com/knowledge-base');
    await page.waitForLoadState('networkidle');
  ...
  test('Backend Knowledge Base API deve estar respondendo', async ({ page }) => {
    ...
    const response = await page.request.get('https://auzap-backend-8xyx.onrender.com/api/v1/knowledge-base').catch(() => null);
